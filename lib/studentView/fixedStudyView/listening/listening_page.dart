  ...
  if (index <= lastUnlockedTask) {
    setState(() {
      ...
      if (index == lastUnlockedTask) {
        ...
        // 检查是否完成了所有任务（最后一个任务）
        if (index == contentCount - 1) {  // contentCount 是当前周的总任务数
            ...
            children: [
              Stack(
                ...
                children: [
                  Icon(
                    Icons.emoji_events,
                    size: ResponsiveSize.w(150),  // 增大奖杯图标
                    color: const Color(0xFFFFD700),
                  ),
                  Positioned(
                    top: ResponsiveSize.h(15),
              ...
              Text(
                ...
                style: TextStyle(
                  fontSize: ResponsiveSize.sp(40),  // 增大标题文字
                  fontWeight: FontWeight.bold,
                  color: const Color(0xFF5C3D2E),
                ),
              ),
              ...
              Text(
                ...
                textAlign: TextAlign.center,
                style: TextStyle(
                  fontSize: ResponsiveSize.sp(28),  // 增大副标题文字
              ...
              Row(
                ...
                children: [
                  Icon(
                    Icons.favorite,
                    color: Colors.red,
                    size: ResponsiveSize.w(30),  // 增大爱心图标
                  ),
                  SizedBox(width: ResponsiveSize.w(10)),
                  Text(
                    '继续保持，你是最棒的！',
                    style: TextStyle(
                      fontSize: ResponsiveSize.sp(24),  // 增大鼓励文字
              ...
              SizedBox(height: ResponsiveSize.h(40)),  // 增加按钮上方间距
              Row(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  ElevatedButton(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Text(
                          '分享成就',
                          style: TextStyle(
                            fontSize: ResponsiveSize.sp(20),  // 增大按钮文字
                          ),
                        ),
                      ],
                    ),
                  ),
                  SizedBox(width: ResponsiveSize.w(20)),  // 增加按钮间距
                  ElevatedButton(
