...
class RhythmPage extends StatefulWidget {
  ...
  @override
  State<RhythmPage> createState() => _RhythmPageState();
}

class _RhythmPageState extends State<RhythmPage> {
        ...
        content: Center(
          child: Container(
            constraints: BoxConstraints(
              maxWidth: ResponsiveSize.w(500),  // 增加宽度
              maxHeight: MediaQuery.of(context).size.height * 0.8,
            ),
            padding: EdgeInsets.all(ResponsiveSize.w(30)),  // 增加内边距
            decoration: BoxDecoration(
              color: Colors.white,
              borderRadius: BorderRadius.circular(ResponsiveSize.w(40)),  // 增加圆角
              border: Border.all(
                color: const Color(0xFFFFD700),
                width: ResponsiveSize.w(4),  // 增加边框宽度
              ),
              boxShadow: [
                BoxShadow(
              ...
              children: [
                Stack(
                  ...
                  children: [
                    Icon(
                      Icons.emoji_events,
                      size: ResponsiveSize.w(150),  // 增加图标大小
                      color: const Color(0xFFFFD700),
                    ),
                    Positioned(
                      top: ResponsiveSize.h(15),
                      ...
                      child: Icon(
                        Icons.star,
                        size: ResponsiveSize.w(50),  // 增加星星大小
                ...
                Text(
                  ...
                  style: TextStyle(
                    fontSize: ResponsiveSize.sp(40),  // 增加文字大小
                    fontWeight: FontWeight.bold,
                    color: const Color(0xFF5C3D2E),
                  ),
                ),
                ...
                Text(
                  ...
                  textAlign: TextAlign.center,
                  style: TextStyle(
                    fontSize: ResponsiveSize.sp(28),  // 增加文字大小
                ...
                Row(
                  ...
                  children: [
                    Icon(
                      Icons.favorite,
                      color: Colors.red,
                      size: ResponsiveSize.w(30),  // 增加图标大小
                    ),
                    SizedBox(width: ResponsiveSize.w(10)),
                    Text(
                      '继续保持，你是最棒的!',
                      style: TextStyle(
                        fontSize: ResponsiveSize.sp(24),  // 增加文字大小
                ...
                SizedBox(height: ResponsiveSize.h(40)),  // 增加间距
                Row(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                    ElevatedButton(
                      ...
                      style: ElevatedButton.styleFrom(
                        ...
                        padding: EdgeInsets.symmetric(
                          ...
                          vertical: ResponsiveSize.h(15),  // 增加按钮高度
                        ),
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Text(
                            '分享成就',
                            style: TextStyle(
                              fontSize: ResponsiveSize.sp(20),  // 增加按钮文字大小
                            ),
                          ),
                        ],
                      ),
