...
class ReadingHomeworkPage extends StatefulWidget {
  final Map<String, dynamic> homework;

  const ReadingHomeworkPage({
    super.key,
    required this.homework,
  });

  @override
  State<ReadingHomeworkPage> createState() => _ReadingHomeworkPageState();
}

class _ReadingHomeworkPageState extends State<ReadingHomeworkPage> {
